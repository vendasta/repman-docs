...
For more information on responding to reviews please visit the page: How to respond to reviews in Reputation Management. Also watch the video webinar about the response templates.