...
You can click on **View Possible Matches** to see a dropdown of listings that the system has pulled in that may belong to your business. Here you can add the listing to your profile by clicking **Monitor this Listing**, or create a new listing or manually submit a listing URL. [Learn more about manually submitting a listing URL here.](/vendasta-products/vendasta-products-reputation-management/vendasta-products-reputation-management-listings/manually-submit-listing-url)
...
Once a Reputation Management account has been created, we will begin looking for the listing on the selected sources immediately. A source may return several matches, at which point we use [Best Match](/vendasta-products/vendasta-products-reputation-management/vendasta-products-reputation-management-listings/best-match) to determine which of the listings are relevant for that business. We schedule searches for new listings on a source every 24 hours for the first 7 days after the profile or source is added. After 7 days, we will check for new listings once per week.
