...
Once a listing is found in the Listings tab through [Best Match](/vendasta-products/reputation-management/listings/best-match) or manually accepted by a user (Marked as Mine), the process to start finding related reviews is triggered. After this initial trigger, we will search for new reviews **once every 24 hours**.
