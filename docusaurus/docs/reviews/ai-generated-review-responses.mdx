...
<iframe 
  src="https://www.youtube-nocookie.com/embed/0o8uzipE_fg" 
  width="560" 
  height="315" 
  frameBorder="0" 
  allowFullScreen
...
To ensure the [AI response templates](/vendasta-products/reputation-management/response-templates-getting-started) appear, users need to have response templates that cover all star ratings, including the missing 1-star or 2-star cases. 
