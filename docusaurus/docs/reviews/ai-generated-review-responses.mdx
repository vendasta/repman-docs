...
To ensure the [AI response templates](../templates/response-templates-getting-started) appear, users need to have response templates that cover all star ratings, including the missing 1-star or 2-star cases. 
