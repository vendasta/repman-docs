...
Users have the ability to edit which listings show in Reputation Management by checking on/off the boxes under Reputation Management > Listings Tab > Listings. You can read more about this [here](/vendasta-products/reputation-management/listings-customize-available-listing-sources).
